...
const character_weights = [
  7.8, 2.0, 4.0, 3.8, 11.0, 1.4, 3.0, 2.3, 8.6, 0.21, 0.97, 5.3, 2.7, 7.2, 6.1,
  2.8, 0.19, 7.3, 8.7, 6.7, 3.3, 1.0, 0.91, 0.27, 1.6, 0.44,
];
...
async function generate() {
  ...
  for (
    let i = 0;
    i < getRandomInt(+min_length_input.value, +max_length_input.value + 1);
    i++
  ) {
